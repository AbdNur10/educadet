...
const Footer = () => {
  return (
    <div className="bg-[rgb(0,20,34)] w-full py-8 px-4 md:px-6 flex flex-col md:flex-row items-center justify-between md:justify-around gap-8">
      ...
      {/* Contact Us Section */}
      <motion.div
        className="text-white flex flex-col items-center md:items-start gap-4 text-center md:text-center"
        initial="hidden"
        animate="visible"
        variants={sectionVariants}
  ...
  {/* Phone Number */}
  <div className="flex items-center gap-2 text-sm md:text-base text-center">
    <IoCallOutline className="text-lg" />
    <a href="tel:+8801315851280" className="hover:text-blue-600 text-center">
      +880 1315851280
    </a>
  </div>
  ...
  <div className="flex items-center gap-2 text-sm md:text-base">
    ...
    <a href="mailto:ceo.edupybd@gmail.com" className="hover:text-blue-600">
